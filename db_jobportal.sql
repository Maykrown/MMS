...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 06, 2025 at 02:08 PM
...
(2025022, 'silent', 'coder', 'c', 'sample', 'Female', 'none', '1974-11-17', 'sample', 50, 'employee', '8151325dcdbae9e0ff95f9f9658432dbedfdb209', 'silentcoderx111@gmail.com', '27429830', 'sample', 'photos/mit.jpg', NULL);
...
(202500002, 3, 'Resume', 'photos/04032025115349GatesBookStore-master (1).zip', 2025022),
...
CREATE TABLE `tblemployees` (
  ...
  `WORKSTATS` varchar(20) DEFAULT NULL,
  `EMPPHOTO` varchar(20) DEFAULT NULL,
...
(77, '1257162', 'Silent', 'Coder', 'C', 'sample', '1994-03-17', 'sample', 30, 'Male', 'Single', '3247289983', 'silentcoderx111@gmail.com', NULL, 'sample1', NULL, NULL, '1257162', 'f79664eaa4ce9b7f848e3ab38a0b9aff98db57f9', '2025-03-05', 7);
...
(3, 2, 'Managerial', 'sample', 3, 15000, '20', 'sample', 'sample', 'Male', 'sample', NULL, '2025-03-04 11:43:00');
...
(6, 2, 3, 2025022, 'ahjdsb skjafhjs', '2025-03-04', 'Approved', 202500002, 0, 0, '2025-03-04 19:05:04');
...
('00018', 'Silent', 'admin', 'd033e22ae348aeb5660fc2140aec35850c4da997', 'Administrator', 'photos/pofile.webp'),
('029838', 'Silent', 'staff', '2f1960487aa2dd5d00b75bf60bd2bcb8307210b2', 'Staff', NULL),
('1257162', 'Silent Coder', 'Coder', 'f79664eaa4ce9b7f848e3ab38a0b9aff98db57f9', 'Employee', NULL),
...
--
ALTER TABLE `tblapplicants`
  MODIFY `APPLICANTID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2025023;
